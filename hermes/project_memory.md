...
Append-stable facts about the project. These should change rarely. If one of these changes, the Gatekeeper updates `docs/SSOT.md` first, and this file follows.

---

- **Official brand:** Zidni Academy
- **Repo:** `lemneya/Zacademy`
- **Beachhead:** Nouadhibou
- **National ambition:** Mauritania
- **First product:** 28-day AI Skills Certificate
